function applyBitcoinbarData(elem, data) {
	...
	elem.html("<div class='bar'></div><div class='text'>"+balance_btc.toFixed(3)+" BTC <span class='goal'>of "+elem.data("goal")+" BTC</span><br>Donate bitcoin<br>Send to this address ➟</div>")
